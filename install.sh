...
PACKAGES_UI=(
    polybar dunst feh lxappearance network-manager-gnome lxpolkit
)
...
if [ "$ONLY_CONFIG" = false ]; then
    ...
    git clone --progress https://github.com/trizen/Linux-DesktopFiles.git || die "Failed to clone Linux-DesktopFiles"
    ...
    git clone --progress https://github.com/trizen/obmenu-generator.git
